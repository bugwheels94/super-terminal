import { useState, useRef, useContext, useEffect, useMemo, ReactNode, forwardRef } from 'react';
import { BsPlusLg, BsGear, BsTerminal, BsPlay, BsFolderX, BsFolder } from 'react-icons/bs';
...
function ContextMenu({
	...
	setScriptVisible: React.Dispatch<React.SetStateAction<boolean>>;
}) {
