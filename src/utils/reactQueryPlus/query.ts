...
>(
  ...
  queryFn: QueryFunction<PromiseResolutionData, any>,
  options: Omit<
    UseQueryOptions<PromiseResolutionData, TError, SelectedData, any>,
    "queryKey"
  > & {
  ...
  const result = useQuery<PromiseResolutionData, TError, SelectedData, any>({
    queryKey: actualKey as any,
    queryFn,
